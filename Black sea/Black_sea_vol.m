...
% This code is designed to load in bathymetry of the Black Sea from GEBCO
...
clear all
% ncdisp('gebco_2022_n45.1033_s40.8_w28.2_e41.9194.nc')
lat=ncread('gebco_2022_n45.1033_s40.8_w28.2_e41.9194.nc','lat'); % lat in degree N
long=ncread('gebco_2022_n45.1033_s40.8_w28.2_e41.9194.nc','lon'); % lat in degree E
z=ncread('gebco_2022_n45.1033_s40.8_w28.2_e41.9194.nc','elevation'); % elevation in m. Note that depth is negative
...
zlabel('Elevation/m')
title('Downloaded Black Sea bathymetry')
...
zbot=double(-2200); % deepest point
% ztop=double(zbot+400); % 400 m from bottom
ztop=double(-1750); % 400 m from bottom
...
ylabel(['Latitude/' char(176) 'N'])
zlabel('Elevation/m')
title('Selected Black Sea bathymetry')
